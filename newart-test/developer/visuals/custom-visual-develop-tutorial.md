...
3. Чтобы установить **core-JS @ no__t-1 в PowerShell, введите следующую команду.
    ...
    Эта команда устанавливает модульную библиотеку стандартных модулей для JavaScript. Он включает в себя прекрашенные для ECMAScript до 2019. Дополнительные сведения [`core-js`](https://www.npmjs.com/package/core-js)

4. Чтобы установить **powerbi-Visual-API @ no__t-1 в PowerShell, введите следующую команду.
    ...
    Эта команда устанавливает определения API Power BI визуальных элементов.
...
7. Убедитесь, что файл **index. d. TS @ no__t-1 добавлен, развернув node_modules > @types > D3 в области **Explorer @ no__t-4.
...
## <a name="process-data-in-the-visual-code"></a>Обработка данных в визуальном коде
...
### <a name="consume-data-in-the-visual-code"></a>Использование данных в визуальном коде

1. В @no__t 0Visual Studio Code @ no__t-1 в файле **visual. TS @ no__t-3,

    Импорт интерфейса `DataView` из модуля `powerbi`

    ```typescript
    import DataView = powerbi.DataView;
    ```

    и добавьте следующий оператор в качестве первого оператора метода Update.
